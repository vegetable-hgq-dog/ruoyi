package com.ruoyi.project.system.processing.mapper;
 ...
 * @date 2022-05-19
 */
public interface DsProcessingMapper 
{
    /**
     * 查询工艺信息
     * 
     ...
     * 批量删除工艺信息
     * 
     * @param processingids 需要删除的数据ID
     * @return 结果
     */
    public int deleteDsProcessingByIds(String[] processingids);
}
