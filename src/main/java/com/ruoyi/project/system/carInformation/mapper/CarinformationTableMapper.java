package com.ruoyi.project.system.carInformation.mapper;
 ...
 * @date 2022-10-14
 */
public interface CarinformationTableMapper 
{
    /**
     * 查询车辆信息
     * 
    ...
    public CarinformationTable selectByLicenseplate(String licenseplate);

    public int updateCarinformation(CarinformationTable carinformationTable);
}
